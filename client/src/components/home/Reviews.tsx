...
import { FeedbackGate } from "@/components/home/FeedbackGate";

// Nota: testemunhos ilustrativos com clientes anónimos por zona — substituir progressivamente por avaliações reais.
const reviews = [
...
const ReviewCard = ({ review }: { review: typeof reviews[0] }) => (
  <div className="bg-white p-6 md:p-7 rounded-[4px] border border-[#2B1B4E]/10 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.08)] transition-all duration-300 group relative flex flex-col hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)] cursor-default h-full">
    ...
    <p className="text-[#2B1B4E] text-xs md:text-[15px] leading-relaxed mb-4 md:mb-5 flex-grow font-bold italic">
      "{review.content}"
    </p>

    <div className="flex flex-col pt-4 md:pt-5 border-t border-slate-100 mt-auto">
      <h4 className="font-bold uppercase tracking-tighter text-[#2B1B4E] text-[10px] md:text-[13px] truncate w-full">{review.name}</h4>
        ...
        <div className="container mx-auto px-6 md:px-8 xl:px-12 max-w-[1400px]">
          <div className="mb-8 md:mb-12 text-center">
            <div className="inline-block bg-[#2B1B4E] text-white px-4 py-1 mb-4 md:mb-6">
              <span className="text-[10px] md:text-xs font-bold uppercase tracking-[0.1em]">Depoimentos</span>
            </div>
            <h3 className="text-[1.5rem] md:text-5xl font-bold text-[#2B1B4E] uppercase tracking-tighter leading-tight mb-4">
