...
export function ShopSection() {
  ...
  return (
    <section id="shop" className="py-12 md:py-24 bg-[#1B5E20]">
      <div className="container mx-auto px-4 md:px-8 xl:px-12 max-w-[1400px] relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-16">
          <div className="flex-1 w-full text-center md:text-left">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 md:px-4 py-2 bg-[#4CAF50]/20 rounded-full mb-5 md:mb-8 mx-auto md:mx-0">
                <ShoppingBag className="w-4 h-4 text-[#4CAF50]" />
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#4CAF50]">[Nome da Empresa]</span>
              </div>

              <h2 className="text-3xl md:text-6xl font-black text-white uppercase tracking-tighter leading-[0.9] mb-5 md:mb-8">
                [PRODUTOS E] <br className="md:block" />
                <span className="text-[#4CAF50]">[ACESSÓRIOS]</span>
              </h2>
              ...
              <p className="text-[11px] md:text-lg font-light text-white/70 mb-6 md:mb-10 leading-relaxed uppercase tracking-widest max-w-xl mx-auto md:mx-0 px-4 md:px-0">
                [Descrição curta sobre a gama de produtos/serviços oferecidos.]
              </p>
          ...
          <div className="flex-1 w-full flex flex-col gap-5 md:gap-8">
            ...
            >
              <div className="absolute inset-0 bg-[#4CAF50]/10 mix-blend-overlay z-10" />
              <ImagePlaceholder
                label="[Imagem de Produtos/Catálogo]"
                width={1200}
                height={675}
            ...
            >
              <a href="tel:+000000000" className="w-full sm:flex-1">
                <Button className="w-full bg-[#1B5E20] hover:bg-[#4CAF50] text-white font-black h-12 md:h-14 rounded-[4px] uppercase tracking-widest text-xs flex items-center justify-center gap-2 transition-all shadow-lg">
